...
def generate_heatmap(author, heatmap_data, start_year, curr_year, tracing_year_span):
    ...
    ax.imshow(heatmap_data[:tracing_year_span, :], cmap=cmap, aspect='auto', vmin=0)
    ...
    title_text=ax.set_title(f"Research Heatmap of {author['name']}   ",loc='right',y=0,pad=10)
...
if __name__ == "__main__":
 ...
 [3.0000e+01,  0.0000e+00,  0.0000e+00,  0.0000e+00,  0.0000e+00,  0.0000e+00, 
  ...
  0.0000e+00,  0.0000e+00,  0.0000e+00,  0.0000e+00,  0.0000e+00,  0.0000e+00, 
  0.0000e+00,  0.0000e+00,  0.0000e+00,  0.0000e+00,  0.0000e+00,  0.0000e+00, ] ])
    generate_heatmap({"name": "Yann Lecun"}, np.array(heatmap), 1994, 2023, 30)
